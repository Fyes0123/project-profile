      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-3xl w-full">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Saya adalah mahasiswa Teknologi Informasi di Fakultas Vokasi, Universitas Brawijaya. Saya lahir di Kepanjen pada Januari 2006. Pada awalnya saya tidak memiliki rencana untuk masuk kedunia TI, tapi itu berubah saat saya lolos pendaftaran di salah satu SMK TI di kota Malang. Saya rasa bahwa belajar TI cukup cocok di saya terutama sebagai UI/UX Designer.
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-800">
            Jl. Bendungan Sengguruh No.21B, Kota Malang
          </p>
        </div>
